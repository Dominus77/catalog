...
class OrdersController extends Controller
{
    ...
    /**
     * Displays a single CatalogOrder model.
     * @param integer $id
     * @return string
    ...
    /**
     * Creates a new CatalogOrder model.
    ...
    /**
     * Updates an existing CatalogOrder model.
    ...
    /**
     * Deletes an existing CatalogOrder model.
